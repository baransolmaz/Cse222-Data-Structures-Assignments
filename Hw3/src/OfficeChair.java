/**Office Chair Class Extends Abstract Furniture Class */
public class OfficeChair extends Furniture{
    private String name="Office Chair";
    private String models[]={"model1","model2","model3","model4","model5","model6","model7"};
    private String colors[]={"color1","color2","color3","color4","color5"};
